...
import com.ydh.gva.util.net.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     *
     * @deprecated Use {@link #Request(int, String, com.ydh.gva.util.net.volley.Response.ErrorListener)}.
     */
    @Deprecated
    ...
    /**
     * @return this request's {@link com.ydh.gva.util.net.volley.Response.ErrorListener}.
     */
